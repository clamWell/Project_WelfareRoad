...
function resetVariables() {
	...
	0 == isFishStillAnimating && (canAnimateFishInformation = !0), // 앞이 true면 실행 false 면 실행하지 않음. isFish~~이 false 여야 0. 즉 isFishStillAnimating이 false 면 canAnimateFishInformation 은 true
...
function resetFunctions() {
	...
	positionExperience2Elements(), positionExperience3Elements(), positionSocialContainer(), positionExperienceTextContainer(), positionChainBlockAndStringContainer(), resetFireworkSvg()
}
